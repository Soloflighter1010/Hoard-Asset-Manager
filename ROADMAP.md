...
- Large libraries (from the 2.3.1 review, see docs/security-review-2.3.1-response.md)
	- **Done** (2.8.2): only draw what's on screen, in both views (P-02); the lists are gzipped
	...
	- **Done** (2.8.2): match tags through a word index instead of trying every tag on every name (P-04)
	- **Done** (2.8.2): rebuild the downloads index without holding up other requests (P-07)
